...
module.exports = async (client, interaction, args) => {
    ...
    return Promise.all(promises)
        .then(async results => {
            ...
            client.embed({
                title: `ℹ・Bot informacion`,
                desc: `____________________________`,
                thumbnail: client.user.avatarURL({ size: 1024 }),
                fields: [{
                name: "📢┆Alerta!",
                value: 'Después de más de 1 año, decidimos detener Bot el 15 de abril, para obtener más información, visite [este servidor] (https://discord.gg/techpoint)',
                inline: false,
               },
               {
                    name: "ℹ️┆Informacion",
                    value: `¡Bot es un bot con el que puedes ejecutar todo tu servidor! ¡Con no menos de 350+ comandos, tenemos un gran bot con muchas opciones para mejorar su servidor!
`,
                    inline: false,
                },
                {
